...
export const loginGoogle = (agent, setUser) => {
  ...
  if (
    ...
    Swal.fire({
      ...
      text: "We are so sorry but data entry from Safari is not supported for now, please use another browser. The website is under construction and we will support Safari soon!",
      icon: "error",
